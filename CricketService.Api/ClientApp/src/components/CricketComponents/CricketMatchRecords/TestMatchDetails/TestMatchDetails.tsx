...
export const TestMatchDetails: React.FunctionComponent<
        ...
        <tbody>
          ...
          <tr>
            <td>
              ...
              {matchData?.team1.inning1.playing11.length}
            </td>
            <td>
              {matchData?.team1.inning1.playing11.map((u) => (
                <p>{u.name}</p>
              ))}
            </td>
          </tr>
          <tr>
            <td>
              ...
              {matchData?.team2.inning1.playing11?.length}
            </td>
            <td>
              {matchData?.team2.inning1.playing11?.map((u) => (
                <p>{u.name}</p>
              ))}
            </td>
          </tr>
      ...
      <div className="match-scoreboard">
        <div className="first-inning-scorecard">
          ...
          <TeamScoreCard
            ...
            teamScoreCard={matchData?.team1.inning1}
        ...
        <div className="second-inning-scorecard">
          ...
          <TeamScoreCard
            ...
            teamScoreCard={matchData?.team2.inning1}
            opponent={matchData?.team1.teamName}
            teamName={matchData?.team2.teamName}
          />
        </div>
        <div className="third-inning-scorecard">
          <h1>Third Inning</h1>
          <TeamScoreCard
            teamData={
              teamData.find(
            ...
            teamScoreCard={matchData?.team1.inning2}
            opponent={matchData?.team2.teamName}
            teamName={matchData?.team1.teamName}
          />
        </div>
        <div className="fourth-inning-scorecard">
          <h1>Fourth Inning</h1>
          <TeamScoreCard
            teamData={
              teamData.find(
            ...
            teamScoreCard={matchData?.team2.inning2}
            opponent={matchData?.team1.teamName}
            teamName={matchData?.team2.teamName}
          />
        </div>
