...
export const MatchRecordsTable: React.FunctionComponent<MatchRecordsTableProps> = ({ matchData }) => {
        ...
        <ReactTable
            ...
            children={
                <ReactSlidingSidePanel
                    ...
                    panelWidth={100}
                    children={<MatchDetails matchData={matchData.find(m => m.matchUuid === selectedMatchUuid) as CricketMatch} />} />}
            handleRowClick={(e, r) => {
