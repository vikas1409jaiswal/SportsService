...
import { ReactSlidingSidePanel, SidePanelType } from '../../../common/ReactSlidingSidePanel';
...
export const T20IPlayersRecords: React.FunctionComponent<T20IPlayersRecordsProps> = ({ isLoading, players }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.t20Career.battingStatistics.matches"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.t20Career.battingStatistics.runs"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.t20Career.battingStatistics.ballsFaced"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.t20Career.battingStatistics.centuries"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.t20Career.battingStatistics.halfCenturies"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.t20Career.battingStatistics.sixes"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.t20Career.battingStatistics.fours"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.t20Career.battingStatistics.wickets"] + sum, 0),
                    [info.rows]
                )
    ...
    const playerSelectedData = players?.find(x => x.playerUuid === selectedPlayerUuid);
