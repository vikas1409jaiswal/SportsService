...
export const ODIPlayersRecords: React.FunctionComponent<ODIPlayersRecordsProps> = ({ isLoading, players }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.odiCareer.battingStatistics.matches"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.odiCareer.battingStatistics.runs"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.odiCareer.battingStatistics.ballsFaced"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.odiCareer.battingStatistics.centuries"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.odiCareer.battingStatistics.halfCenturies"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.odiCareer.battingStatistics.sixes"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.odiCareer.battingStatistics.fours"] + sum, 0),
                    [info.rows]
                )
        ...
        },
        {
            ...
            Footer: (info: any) => {
                const total = React.useMemo(
                    () =>
                        info.rows.reduce((sum: number, row: any) => row.values["careerDetails.odiCareer.battingStatistics.wickets"] + sum, 0),
                    [info.rows]
                )
