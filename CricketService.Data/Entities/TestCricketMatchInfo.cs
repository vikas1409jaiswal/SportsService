...
namespace CricketService.Data.Entities
{
    ...
    public class TestCricketMatchInfo
    {
        [Key]
        [Column("uuid")]
        ...
        [Column("match_date")]
        public string MatchDates { get; set; } = string.Empty;
        ...
        public TestTeamScoreDetailsRequest Team1 { get; set; } = null!;

        [Column("team2_details")]
        public TestTeamScoreDetailsRequest Team2 { get; set; } = null!;
